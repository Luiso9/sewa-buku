                    ...
                    <div class="box-body table-responsive padding">
                      ...
                      <table id="datatable" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                         <?php $no=1; 
                          $qdatagrid ="  SELECT 
                           t_diagnosa.kd_diagnosa, t_diagnosa.cf_gejala, 
						   ...
						   t_gejala.kode_gejala, t_gejala.nm_gejala
                            ...
                            while($ddatagrid=mysqli_fetch_assoc($rdatagrid)) {
                                ...
                                <tr>
                                     ...
                                     <td style= text-align:center>$ddatagrid[cf_gejala]</td>
...
?>
			<div class="main-content">
             ...
             <form class="form-horizontal" name="tambah_subkat" id="tambah_subkat" method="post" action="?unit=dbp_unit&act=inputact" enctype="multipart/form-data">
                      ...
                      <?php
                        $qcombo = 
                        "
                        SELECT * FROM t_penyakit limit 1
                        ";
				  ...
				  <div class="form-group">
                     ...
                     <div class="col-sm-9">
                      ...
                      <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5" type="text" name="cf" id="cf" required    />
                       </div>
                       </div>
 ...
 <?php
        ...
        case "inputact":
          ...
          ( kode_penyakit, kode_gejala, cf_gejala)
          VALUES
          ('$kode_penyakit', '$kode_gejala','$cf')
        ";
...
<div class="form-group">
				  ...
				  <div class="form-group">
                     ...
                     <div class="col-sm-9">
                        ...
                        <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="mb">CF</label>
                      <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5" type="text" name="cf" id="cf" value="<?php echo $dupdate['cf_gejala'] ?>" required    />
                       </div>
                       </div>
