                              ...
                              <table id="datatable" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">pencegahan</th>
                                ...
                                <tbody>
                                    ...
                                    while($ddatagrid=mysqli_fetch_assoc($rdatagrid)) {
										if (strlen($ddatagrid[penyebab]) > 150)
										{
											$maxLength = 140;
											$ddatagrid[penyebab] = substr($ddatagrid[penyebab], 0, $maxLength);
											}
										if (strlen($ddatagrid[pencegahan]) > 150)
										{
											$maxLength = 140;
											$ddatagrid[pencegahan] = substr($ddatagrid[pencegahan], 0, $maxLength);
											}
                                        ...
                                        <tr>
                                             ...
                                             <td style= text-align:left  >$ddatagrid[penyebab]</td>
                                             <td style= text-align:left  >$ddatagrid[pencegahan]</td>
                ...
                $newID = $char.sprintf("%01s",$no_urut);
                  ...
                  <form class="form-horizontal" id="tambah_kat" name="tambah_kat" method="post" action="?unit=penyakit_unit&act=inputact" enctype="multipart/form-data" >    
                      ...
                      <div class="form-group">
					   ...
					   <div class="form-group">
                   <label class="col-sm-3 control-label no-padding-right"  for="penyebab">Penyebab</label>	
                   <div class="col-sm-9">
                   <textarea class="form-control limited" name="penyebab" id="penyebab"> </textarea>	
                    </div>
                       </div>
					   
					   <div class="form-group">
                   <label class="col-sm-3 control-label no-padding-right"  for="pencegahan">Pencegahan</label>	
                   <div class="col-sm-9">
                   <textarea class="form-control limited" name="pencegahan" id="pencegahan"> </textarea>	
                    </div>
                       </div>
...
//  frmvalidator.addValidation("penyebab","req","Silakan Masukkan Penyebab");
//   frmvalidator.addValidation("pencegahan","req","Silakan Masukkan pencegahan");
...
<?php
        ...
        case "inputact":
          ...
          (kd_penyakit, nm_penyakit, penyebab, pencegahan, penanganan)
          VALUES
          ('$kd_penyakit', '$nm_penyakit', '$penyebab', '$pencegahan', '$penanganan')
        ";
...
?>       
			...
			<div class="main-content">
              ...
              <form class="form-horizontal" id="tambah_kat" name="tambah_kat" method="post" action="adminmainapp.php?unit=penyakit_unit&act=updateact">    
                   ...
                   <label class="col-sm-3 control-label no-padding-right"  for="penyebab">Penyebab</label>	
                   <div class="col-sm-9">
                   <textarea class="form-control limited" name="penyebab" id="penyebab"><?php echo $dupdate['penyebab'] ?> </textarea>	
                    </div>
                       </div>
                   ...
                   <label class="col-sm-3 control-label no-padding-right"  for="pencegahan">Pencegahan</label>	
                   <div class="col-sm-9">
                   <textarea class="form-control limited" name="pencegahan" id="pencegahan"><?php echo $dupdate['pencegahan'] ?> </textarea>	
                    </div>
                       </div>
