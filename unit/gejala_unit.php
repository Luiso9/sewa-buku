                                ...
                                <tbody>
                                    ...
                                    while($ddatagrid=mysqli_fetch_assoc($rdatagrid)) {
                                        ...
                                        <tr>
                                             ...
                                             <td style= text-align:center  ><?= $ddatagrid['pertanyaan'] ?></td>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right">Pertanyaan</label>
                            <div class="col-sm-9">
                                <input class="col-xs-10 col-sm-5" type="text" name="pertanyaan" id="pertanyaan" required="required"/>
                            </div>
                       </div>
...
<?php
        ...
        case "inputact":
          ...
          (kd_gejala, nm_gejala, pertanyaan)
          VALUES
          ('$kd_gejala', '$nm_gejala', '$pertanyaan')
        ";
                 ...
                 <form class="form-horizontal" id="tambah_brand" nama="tambah_brand"  method="post" action="adminmainapp.php?unit=gejala_unit&act=updateact" enctype="multipart/form-data"  >    
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          <label class="col-sm-3 control-label no-padding-right">Pertanyaan</label>
                            <div class="col-sm-9">
                                <input class="col-xs-10 col-sm-5" type="text" name="pertanyaan" id="pertanyaan" required="required" value="<?= $dupdate['pertanyaan']?>" />
                            </div>
                       </div>
