...
<form class="form-horizontal" method="post" action="?unit=admin_unit&act=inputact" enctype="multipart/form-data" >
             ...
             <div class="form-group">
                      ...
                      <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5" type="text" name="status" id="status" value="admin" readonly="readonly" required    />
                       </div>
                       </div>
...
<form class="form-horizontal" method="post" action="?unit=admin_unit&act=updateact" enctype="multipart/form-data" >
             ...
             <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="email">Alamat</label>
                      <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5" type="text" name="alamat" id="alamat" value="<?= $dupdate['alamat'] ?>" required    />
                       </div>
                       </div>
					   <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="email">Email</label>
