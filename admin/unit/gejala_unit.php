    ...
    switch ($act) {
        case "datagrid":
            ...
            <?php
                ...
                <div class="mx-auto my-4 bg-white shadow-md rounded my-6">
                    <div class="px-6 py-4 flex justify-between items-center border-b mb-4 shadow-md rounded-l border-black mx-6">
                        <h2 class="text-xl font-semibold">Data Penyewaan Buku</h2>
                        <a href="?unit=gejala_unit&act=input" class="bg-green-500 text-white px-4 py-2 rounded">Tambah Data</a>
                    </div>
                    <div class="grid grid-cols-1 grid-rows-1 gap-1 mx-6">
                        <table class="min-w-full text-xl bg-gray-200 border border-gray-200">
                            <thead>
