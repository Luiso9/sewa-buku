...
<td style="width:250px;"> &nbsp; <?php echo $ddatagrid['nm_gejala']; ?>&nbsp;</td>
<td style="width:245px;"><span class="kondisipilih"><?php echo $arkondisitext[$kondisi]; ?>&nbsp;</span></td>
</tr>
</tbody>
<?php
} ?></table>
...
<td  style="width:120px;"> &nbsp; <?php echo $vlpkt[$ipl]; ?>&nbsp;</td>
<td  style="width:120px;"> &nbsp; <?php echo round($vlpkt[$ipl], 2); ?>&nbsp;</td>
</tr>
</tbody>
<?php
} ?></table>
...
<table border="1"  style="font-size: 16px; border-collapse: collapse; width: 100%;">
		...
		<tr><td style="font-size: 10px; width: 92%;" > Penyebab	: <?php echo $dupdate['penyebab']; ?></td></tr>
		<tr><td style="font-size: 10px; width: 92%;" > Penceggahan	: <?php echo $dupdate['pencegahan']; ?></td></tr>
